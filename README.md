...
See [`samples/`](./samples) for sanitized code excerpts and [`docs/`](./docs) for architecture and engineering notes.
...
The work represented here is meant to show both product judgment and technical systems thinking — not just a marketing surface.
